...
@section('title', 'Dataset Puskesmas')

@section('header')
    {{ __('Dataset Puskesmas') }}
@endsection
...
@section('content')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        <div class="overflow-x-auto min-h-[300px]">
            <table class="min-w-full bg-white border border-gray-300 text-sm shadow-md rounded-lg overflow-hidden">
        ...
        <div class="mt-4" id="pagination">
            {{ $datasets->appends(request()->query())->links('pagination::bootstrap-4') }}
        </div>
